...
| 2026-06-22 |- Bootstrapped Houdini AI Assistant (Phase 1-4): OOP folder tree, async streaming client, scene context inspector, markdown chat UI, main-thread HOM tool execution, and modal Action Approval dialog.
